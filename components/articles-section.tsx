          ...
          <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
            ...
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">
                Dspace Is now live and on the Sui Blockchain Testnet, Open for Demo Test.
              </h3>
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  <div className="font-bold text-base md:text-lg text-[#0B0B0B]">Dspace</div>
          ...
          <div className="space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  ...
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Avo Hybrid module soon to rollout. Currently under development. Avalable for testing
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    Sui Drop soon to rollout. Currently under development
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Sui Drop soon to rollout on the sui blockchain. mobile app version is Currently under development
                  </p>
                </div>
              </div>
            </div>
