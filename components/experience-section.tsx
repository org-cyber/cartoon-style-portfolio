  ...
  const experiences = [
    {
      ...
      description:
        "Developed Realtime Databases, Dashboards, Content Delivery Systems and APIs for Hauser Property Management System",
    ...
    },
    {
      ...
      description:
        "Developed and integrated AI Automations for Dmiebi IT Ventures Content management system",
