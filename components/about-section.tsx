      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        <div className="flex justify-center">
          <div className="relative w-full max-w-lg aspect-square border-[4px] border-black rounded-full overflow-hidden bg-[#FF6B6B] shadow-[-8px_8px_0px_0px_rgba(0,0,0,1)]">
            <Image src="/images/medark.jpeg" alt="About me illustration" fill className="object-cover" />
          </div>
        </div>
        ...
        <div className="space-y-6 md:space-y-8">
          <div>
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              I’m Kennedy Chinwo, the developer behind these projects. I love turning ideas into working apps — from real-time web and mobile apps to blockchain-powered platforms. I focus on building hybrid solutions that are fast, secure, and user-friendly, while exploring the possibilities of Web3 technology
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base">
                  Building Interactive responsive websites that scale.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold mb-2">4+ successfull projects</h3>
                <p className="text-gray-600 text-sm md:text-base">
                  That showcase my skills and expertise in web development.
                </p>
              </div>
            </div>
          </div>
